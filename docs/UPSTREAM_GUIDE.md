> Preserved upstream guide from base 7801b0445f133bef3d8db0bdae1b9c5670389f4b. For this candidate's optional export and settings, see [JSON export](JSON_EXPORT.md). The main README is the download-first user entry point.
